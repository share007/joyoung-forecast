...
APP_NAME="JoyoungForecast-V2.0-Windows"
...
echo Materials page: http://127.0.0.1:8000/home/forecast/materials/
exit /b 0
...
- 仪表盘：http://127.0.0.1:8000/home/forecast/dashboard/
- 商品基础数据管理：http://127.0.0.1:8000/home/forecast/materials/
- 运行日志在 app\app.log
EOF
